		...
		<div  id="site-footer">
			<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="margin-footer col-div twit">
							<h3>Twitter Feeds</h3>
								<blockquote class="twitter-tweet"><p lang="en" dir="ltr">We are live on social media now. Feel free to follow us <a href="https://twitter.com/Linkaidit?ref_src=twsrc%5Etfw">@Linkaidit</a></p>&mdash; Linkaid (@Linkaidit) <a href="https://twitter.com/Linkaidit/status/922606216492343296?ref_src=twsrc%5Etfw">October 23, 2017</a></blockquote> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>			
						...
						<div class="margin-footer">
							<div class="col-div">
								...
								<div>
									...
									<div class="margin-footer">
										<span>+(234) 8141189211</span><br>
										<span>hello@legomake.com</span>
									</div>
								</div>
								<div>
									<div id="social-pad">
						...
						<div class="margin-footer">
							<div class="margin-footer col-div">
								<ul id="footer-nav" class="margin-footer">
									...
									<li><a href="#" class="a_font">Contact</a></li>
								</ul>
							</div>
						</div>
					</div>
